...
var NSLocationStrategy = /** @class */ (function (_super) {
    ...
    NSLocationStrategy.prototype.findOutlet = function (outletKey, activatedRouteSnapshot) {
        var outlet = this.outlets.find(function (currentOutlet) { return currentOutlet.outletKeys.indexOf(outletKey) > -1; });
        ...
        if (!outlet && activatedRouteSnapshot) {
            ...
            outlet = this.outlets.find(function (currentOutlet) { return currentOutlet.pathByOutlets === pathByOutlets_1; });
        }
        return outlet;
    };
